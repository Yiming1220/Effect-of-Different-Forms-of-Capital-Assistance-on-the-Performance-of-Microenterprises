...
::: {.figure}
![Baseline Balance](../outputs/tables/baseline_balance.png){width=99%}
:::


# Data Cleaning and Processing

Our data cleaning and processing workflow was designed to ensure that the dataset was robust and suitable for the statistical analysis required to answer our research questions. The R programming language (R Core Team 2020), along with a suite of packages including `haven`, `dplyr`, `readr`, `ggplot2`, `knitr`, `kableExtra`, and `stargazer`, was utilized for data manipulation and analysis.
...
::: {.figure}
![Business Outcome](../outputs/tables/business_outcome.png){width=99%}
:::
...
::: {.figure}
![](../outputs/tables/business_outcome_female.png){width=99%}
:::
...
::: {.figure}
![](../outputs/tables/business_outcome_male.png){width=99%}
:::
